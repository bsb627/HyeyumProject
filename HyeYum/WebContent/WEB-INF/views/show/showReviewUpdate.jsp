			...
			<form action="/showReview/update" method="post"
				...
				<div class="row border col-md-12">
					...
					<div class="form-outline col-md-6">
						<div class="col-md-10">
							<input type="text" id="ticket-number" class="form-control active"
					...
					<div class="form-outline col-md-6">
						<div class="col-md-12">
							<input type="text" id="sns-link" class="form-control active"
					...
					<div class="form-outline col-md-12">
						<input type="text" id="show-title" class="form-control active"
