		...
		<div class="container">
			...
			<form action="/showReview/update" method="post" enctype="multipart/form-data">
				...
				<div class="row border col-md-12">
					...
					<div class="col-md-10">
						<input type="text" id="ticket-number" class="form-control active" name="ticket-number" value="<%=review.getTicketNumber() %>" autocomplete="off" required/> <label
					...
					<div class="form-outline col-md-6">
					<div class="col-md-12">
						<input type="text" id="sns-link" class="form-control active" name="sns-link" value="<%=review.getSnsLink() %>" autocomplete="off" required/> <label
					...
					<div class="form-outline col-md-12">
						<input type="text" id="show-title" class="form-control active" name="show-title" value="<%=review.getTitle() %>" autocomplete="off" required maxlength="50"/> <label
